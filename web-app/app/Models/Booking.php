...
#[Table('booking')]
#[Fillable(['nomor_booking','slot_id','sesi_id','nama_pasien','kontak_terenkripsi','tipe_pasien','jenis_pembayaran','keluhan_singkat','status','kadaluarsa_pada','konfirmasi_direncanakan_pada','konfirmasi_terkirim_pada',])]
